<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddLeave.aspx.cs" Inherits="EmpManageApp.AddLeave" %>
...
<asp:HiddenField ID="hfDeptLeaveId" runat="server" />

<div class="container mt-4">
    <h4>Department Leave Allocation</h4>
            ...
            <asp:TemplateField HeaderText="Action">
                <ItemTemplate>
                    <asp:LinkButton runat="server"
                        ...
                        CommandArgument='<%# Eval("deptLeaveId") %>'
...
<div class="modal-header bg-primary text-white">
    <h5 class="modal-title">Add / Edit Leave</h5>
